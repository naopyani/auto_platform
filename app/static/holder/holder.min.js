...
!function (e) {
    ...
    return function (e) {
        ...
        (function (t) {
            ...
            function i(e, t) {
                var n = {theme: T(O.settings.themes.gray, null), stylesheets: t.stylesheets, instanceOptions: t},
                    r = e.indexOf("?"), i = [e];
            ...
            function o(e) {
                ...
                if (r.font && (s.font = r.font, !v.noFontFallback && "img" === n.nodeName.toLowerCase() && O.setup.supportsCanvas && "svg" === v.renderer && (v = T(v, {renderer: "canvas"}))), r.font && "canvas" == v.renderer && (v.reRender = !0), "background" == t) null == n.getAttribute("data-background-src") && x.setAttr(n, {"data-background-src": m}); else {
                    var y = {};
            ...
            function c() {
                ...
                }), n.length && j.run({images: n}), setTimeout(function () {
            ...
            var m = n(2), v = n(3), y = n(6), w = n(7), b = n(8), x = n(9), S = n(10), A = n(11), C = n(12), E = n(15),
                T = w.extend, k = w.dimensionCheck, F = A.svg_ns, j = {
                    ...
                    return function (r) {
                        ...
                        if (O.setup.supportsSVG) {
                            ...
                            null != e && e.parentNode === document.body || (o = !0), e = b.initSVG(e, i.properties.width, i.properties.height), e.style.display = "block", o && (t = x.newEl("text", F), n = a(null), x.setAttr(t, {x: 0}), t.appendChild(n), e.appendChild(t), document.body.appendChild(e), e.style.visibility = "hidden", e.style.position = "absolute", e.style.top = "-100%", e.style.left = "-100%");
                            ...
                            var u = t.getBBox(), c = Math.ceil(u.width / i.properties.width), d = l.text.split(" "),
                                f = l.text.match(/\\n/g);
                            c += null == f ? 0 : f.length, n.nodeValue = l.text.replace(/[ ]+/g, "");
                            var p = t.getComputedTextLength(), g = u.width - p,
                                m = Math.round(g / Math.max(1, d.length - 1)), v = [];
                            if (c > 1) {
                                n.nodeValue = "";
                            ...
                            return e.style.display = "none", {spaceWidth: m, lineCount: c, boundingBox: u, words: v}
                        }
                        return !1
                    }
                }();
